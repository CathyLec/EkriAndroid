...
public class SucesosAdapter extends ArrayAdapter<Suceso> {
    private final List<Suceso> list;
    private final Context context;

    public SucesosAdapter(Context context, List<Suceso> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.txtDescripcion.setText(list.get(position).getFecha());
